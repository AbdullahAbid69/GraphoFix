        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                <a href=""><img src="{{asset('backend/images/abdullah.jpg')}}" class="wd-80 rounded-circle" alt=""></a>
                <h6 class="logged-fullname">Abdullah Abid - CEO</h6>
                <p>abdullahabidwahcantt@gmail.com</p>
              </div>
              <hr>
              <div class="tx-center">
