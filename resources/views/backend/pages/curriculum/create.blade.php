                ...
                <form action="{{ route('curriculum.store') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg">
                      ...
                      <div class="form-group">
                        <label>Step One Title [Urdu]</label>
                    ...
                    <div class="col-lg">
                      ...
                      <div class="form-group">
                        <label>Step Two Title [Urdu]</label>
                    ...
                    <div class="col-lg">
                      ...
                      <div class="form-group">
                        <label>Step Three Title [Urdu]</label>
                    ...
                    <div class="col-lg">
                      ...
                      <div class="form-group">
                        <label>Step Four Title [Urdu]</label>
                    ...
                    <div class="col-lg">
                      ...
                      <div class="form-group">
                        <label>Step Five Title [Urdu]</label>
