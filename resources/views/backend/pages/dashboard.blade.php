    ...
    <div class="row row-sm mg-t-20">
        ...
        <div class="card bd-0 shadow-base">
            ...
            <div>
                ...
                <p>Past 30 Days — Last Updated Dec 11, 2023</p>
            </div>
            <div class="d-sm-flex">
                <div>
        ...
        <div class="card bd-0 shadow-base pd-25 mg-t-20">
            ...
            <div>
                <h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1">How Engaged Our Users Daily</h6>
                <p>Past 30 Days — Last Updated Nov 14, 2023</p>
            </div>
            <div class="wd-200">
        ...
        <div class="card shadow-base bd-0 pd-25 mg-t-20">
            ...
            <div>
                ...
                <p class="mg-b-0">Past 30 Days — Last Updated Nov 20, 2023</p>
            </div>
        ...
        <div class="card card-body bd-0 pd-25 bg-primary mg-t-20">
            ...
            <p class="tx-11 mg-b-0 mg-t-15 tx-white-7">Notice: It will not be returned if yo break it by yourself.</p>
        </div><!-- card -->
